...
* Fri Sep 07 2007 Funda Wang <fwang@mandriva.org> 10.1-3mdv2008.0
+ Revision: 82145
- Rebuild for new era
- Import howto-html-el



* Thu Jul 07 2005 Thierry Vignaud <tvignaud@mandrakesoft.com> 10.1-2mdk
- fix menu entry (#16623)
...
* Tue Mar 13 2001 Thierry Vignaud <tvignaud@mandrakesoft.com> 8.0-2mdk
- fix tmppath
...
* Fri Mar  2 2001 Etienne Faure  <etienne@mandrakesoft.com> 7.1-7mdk
- rebuild with new howto-utils

* Sat Jan 13 2001 Etienne Faure  <etienne@mandrakesoft.com> 7.1-6mdk
- modified menu entry

* Fri Dec 15 2000 Etienne Faure  <etienne@mandraksoft.com> 7.1-5mdk
- updated howtos
- added icons

* Thu Aug 17 2000 Thierry Vignaud <tvignaud@mandrakesoft.com> 7.1-4mdk
- add LN touch
- fix menu for BM
...
* Fri Aug 11 2000 Thierry Vignaud <tvignaud@mandrakesoft.com> 7.1-3mdk
- use new tool to autogenerate the menu
- fix buildrequires
- new snapshots
- use new macros
- fix menu for BM
